...
enum {
	...
	MML_CMD_PITCHBENDST1   = 0xE3, //! <- Bend by semitone (-8..+7)
	MML_CMD_PITCHBENDST1R  = 0xE4, //! <- Bend by semitone (-8..+7, ramped)
	MML_CMD_PITCHBENDST2   = 0xE5, //! <- Bend by semitone (-128..+127)
	MML_CMD_PITCHBENDST2R  = 0xE6, //! <- Bend by semitone (-128..+127, ramped)
	MML_CMD_RELPITCHBEND     = 0xE7,
	MML_CMD_RELPITCHBENDST1  = 0xE8,
	MML_CMD_RELPITCHBENDST1R = 0xE9,
	MML_CMD_RELPITCHBENDST2  = 0xEA,
	MML_CMD_RELPITCHBENDST2R = 0xEB,
